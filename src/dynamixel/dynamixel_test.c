...
int main(int argc, char **argv)
{
    ...
    getopt_add_string(gopt, 'd', "device", "/dev/ttyUSB0", "USB Dyanmixel device path");
    ...
    getopt_add_bool(gopt, '\0', "home-all", 0, "Command all servos to zero degrees");
