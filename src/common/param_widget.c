...
static void vx_gtk_param_widget_class_init (VXGtkParamWidgetClass *klass);
static void vx_gtk_param_widget_init (VXGtkParamWidget *pw);
static void vx_gtk_param_widget_finalize (GObject *obj);
...
double vx_gtk_param_widget_get_min_double(VXGtkParamWidget *pw,
        const char *name);
double
vx_gtk_param_widget_get_min_double(VXGtkParamWidget *pw,
        const char *name)
{
...
double vx_gtk_param_widget_get_max_double(VXGtkParamWidget *pw,
        const char *name);
double
vx_gtk_param_widget_get_max_double(VXGtkParamWidget *pw,
        const char *name)
{
    param_data_t *pdata = get_param_data_check_type(pw, name, G_TYPE_DOUBLE);
    if(!pdata)
...
static int
add_togglebuttons_helper (VXGtkParamWidget *pw, GtkBox *box, const char *name,
        int checked)
{
    if (have_parameter_key (pw, name)) return -1;
...
static int
add_buttons (VXGtkParamWidget *pw,
        const char *name1,
        va_list ap)
{
...
void
vx_gtk_param_widget_set_int (VXGtkParamWidget *pw, const char *name,
        int val)
{
    if (! have_parameter_key (pw, name)) {
        fprintf(stderr, "param_widget: invalid parameter [%s]\n", name);
...
void
vx_gtk_param_widget_set_double (VXGtkParamWidget *pw, const char *name,
        double val)
{
    param_data_t *pdata = get_param_data_check_type(pw, name, G_TYPE_DOUBLE);
    if(!pdata) {
...
void
vx_gtk_param_widget_set_bool (VXGtkParamWidget *pw, const char *name,
        int val)
{
    if (! have_parameter_key (pw, name)) {
        fprintf(stderr, "param_widget: invalid parameter [%s]\n", name);
...
void
vx_gtk_param_widget_set_enum (VXGtkParamWidget *pw, const char *name,
        int val)
{
    if (! have_parameter_key (pw, name)) {
        fprintf(stderr, "param_widget: invalid parameter [%s]\n", name);
...
void
vx_gtk_param_widget_set_enabled (VXGtkParamWidget *pw, const char *name,
        int enabled)
{
    if (! have_parameter_key (pw, name)) {
        fprintf(stderr, "param_widget: invalid parameter [%s]\n", name);
...
int vx_gtk_param_widget_modify_enum(VXGtkParamWidget *pw, const char *name,
